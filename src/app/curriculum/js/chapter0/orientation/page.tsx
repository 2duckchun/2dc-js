...
export default function Lecture() {
  return (
    <div className={styles.act_container}>
      ...
      <h1>환영합니다!</h1>
      <p>안녕하세요! 꾸준히 성장하며, 아웃풋을 내려고 노력하는 개발자 2DC입니다.</p>
      <p>저는 지식을 공유하는 활동에 관심이 많습니다. 어려서부터 그랬던 것 같아요.</p>
      <p>타인에게 내가 알고있는 것들을 알려줄 수 있는 것만큼 즐거운 것은 없다고 생각합니다.</p>
      <p>
        그래서 이 사이트를 준비했습니다. (타인을 알려주기 위해 공부하는 것이 가장 효과적인
        공부법이라고 하더라구요.)
      </p>
      <br />
      <p>이 커리큘럼은 자바스크립트를 처음 다루시는 분들을 대상으로 합니다.</p>
      <p>한번 쓱 훑어보시되, 기초적인 지식들을 습득하기 좋도록 커리큘럼을 고민했습니다.</p>
      <p>
        커리큘럼의 목적은 여러분들께 (제가 생각하는) 자바스크립트의 기초적인 부분을 재빠르게
        알려드리는 것입니다.
      </p>
      <p>간단하게, 지식의 마중물이라고 하면 좋을 것 같습니다.</p>

      <h2>왜 필요한지 알고 배우기</h2>
      <p>저는 22년 6~7월에 본격적으로 자바스크립트를 본격적으로 공부를 했습니다.</p>
      <p>당시를 회고해보면 너무 무식하고 비효율적으로 공부를 했던 것 같아요.</p>
      <p>이해하지도 못할 벽돌같은 책들을 주렁주렁 사서 읽다가 이해가 안가서 포기하기도 했고요.</p>
      <p>이것만 보면 취업 완성! 비슷한 책들을 사다가 몇번 읽고 던져버리기도 했습니다.</p>
      <p>
        어떻게 꾸역꾸역 보면서 따라하더라도, 이해했다고 착각만 하며 뭔가를 만들어내는 것은 굉장히
        어려웠습니다.
      </p>
      <p>
        그런 인고(?)의 시간이 쌓이다보니, <b>왜 필요한지 알고 배우면 좋았겠다.</b> 라는 생각이 들게
        되었습니다.
      </p>
      <p>
        사실 이렇게 말한다고 해서 제가 많은 것을 아는 개발자는 아닙니다. 배우고 있는 학생이고,
        취준생이기도 합니다.
      </p>
      <p>
        하지만 신분을 떠나, 여러분들께 어떻게 하면 좋은 내용을 효과적으로 전달할 수 있을지
        집중해보려 합니다.
      </p>
      <p>
        물론 저도 많은 공부가 필요하다는 것을 인지하고, 앞으로의 글들을 이어나가보도록 하겠습니다.
      </p>
      ...
      <p>자바스크립트가 우리의 적도 아니고, 배운다고 해서 위태로울 일도 없지만</p>
      <p>
        뭔가를 배우기 전에, 배울 것의 역사나 흐름을 알고 가면 더 흥미롭게 배울 수 있는 것 같습니다.
      </p>
      <p>자바스크립트의 역사를 기가 막히게 알려주시는 유튜브 채널이 하나 있는데요.</p>
      <p>
        너무 좋아서 공유를 드립니다. 홍보는 아니고요. 제가 어줍잖게 설명하는 것 보다 이 영상이
        여러모로 나을 것 같았습니다.
      </p>
      <p>자바스크립트와 웹의 역사! 보고 오시죠!</p>
      <p>유튜브의 알고리즘에 빠지지 마시고, 이 영상만 보시고 바로 돌아와주세요!</p>
      <CustomLink href={{ pathname: 'https://youtu.be/wcsVjmHrUQg' }} isBlank={true}>
      ...
      <p>
        엘리 영상에서도 보셨다시피, 자바스크립트의 근본은 <b>웹(브라우저) 컨트롤</b> 언어 입니다.
      </p>
      ...
      <br />
      <p>
        여기서 나오는 것들은 외우려고 하지 마시고, <b>아! 이런것들을 활용하는군! </b>
        하며 넘어가주시길 부탁드립니다.
      </p>
      <p>여기서 당장 익혀봐야 다시 사용하실 수 없습니다.</p>
      <p>중요한 것은 자력으로 쓸 수 있느냐이며, 어짜피 다시 스스로 익히셔야 합니다.</p>

      <h2>구글 크롬 설치</h2>
      <p>구글 크롬을 설치하고 브라우저를 열어주세요. 여기까지는 잘 해내실거라 믿습니다!</p>
      ...
      <p>
        about:blank는 브라우저가 아무것도 보여줄 게 없을 때 표시하는 빈 페이지입니다. 새하얀
        도화지와 같습니다.
      </p>
      <p>우리는 이 도화지에 오로지 자바스크립트만을 이용해서 자기소개 페이지를 그려보려 합니다.</p>
      ...
      <p>
        요소 탭을 잘 보시면 &lt;html&gt; ... &lt;/html&gt; 내부에 &lt;head&gt;와 &lt;body&gt;.. 이런
        것들을 보실 수 있는데요.
      </p>
      <p>
      ...
      <p>웹 문서도 비슷합니다. 과거의 웹 문서는 논문 공유하는 문서의 역할을 했다고 해요.</p>
      <p>다만 프로그래밍화 된 문서인 것이지요.</p>
      <p>이 웹 문서를 컴퓨터상에 효과적으로 나타내기 위해 html이라는 확장자를 이용하고,</p>
      <p>문서의 구조를 나타내기 위해 고구마 줄기와 비슷한 트리라는 자료구조를 이용하는 것입니다.</p>
      <p>
        (쉽게 말하는 것은 쉽지만 내부에서 어떻게 얽히고 섥혀있는지는 저도 잘 모르겠습니다. ㅎㅎ 차차
        알아가려고 합니다.)
      </p>
      <p>아무튼 웹 문서를 document라고 하는 것 까지는 알겠습니다.</p>
      <br />
      <p>
        그럼 브라우저에서 document는 어떻게 생겼는지 확인하기 위해 <b>콘솔 탭</b>을 눌러 아래 코드를
        입력해봅시다.
      </p>
      ...
      <p>하나의 대상을 여러개의 데이터로 설명하는 데이터 형식을 객체(Object)라고 하는데요.</p>
      <p>
        위의 사진을 보면 document를 설명하기 위한 여러개의 데이터가 묶여있는 것을 보실 수 있지요.
      </p>
      <p>document를 객체로 표현한 것 입니다.</p>
      <p>웹 개발에서는 document를 객체로 표현한 것을 DOM(Document Object Model)이라고 하는데요.</p>
      <p>
        웹 문서 자체가 document이기 때문에, document의 데이터만 잘 다뤄도 거의 모든 것을 하실 수
        있습니다.
      </p>
      ...
      <ol>
        ...
        <li>h1 이라는 엘리먼트를 myNickName이라는 이름으로 메모리에 할당(저장)한다.</li>
        <li>myNickName (h1 엘리먼트) 의 textContent를 &#34;yourNickName &#34;으로 할당한다.</li>
        <li>body의 자식 요소에 myNickName을 추가한다.</li>
      </ol>
      <p>오리엔테이션이니만큼 모든 것을 이해하지 않으셔도 됩니다!</p>
      <p>
        다만 우리가 무엇을 선언할 때, 그것이 컴퓨터의 메모리에 저장된다는 것만 인지하고 넘어가시죠!
      </p>
      <br />
      ...
      <p>대괄호에 둘러 쌓인 데이터(myFavoriteFoodList)와 for라는 키워드가 보이실거에요!</p>
      <p>
        myFavoriteFoodList = [ &#39;something &#39;, &#39;something &#39;, &#39;something &#39;,
        &#39;something &#39;]는 배열(Array)이라고 합니다.
      </p>
      <p>여러가지 데이터를 나열해놓고 묶어두는 역할을 합니다.</p>
      <p>
        한가지 대상을 설명하기 위한 여러 데이터로 구성된 객체(Object)와는 약간 다른 데이터
        형식입니다.
      </p>
      <p>나중에 진지하게 공부해볼 녀석이지요.</p>
      <br />
      <p>
        for 키워드는 <b>특정 조건이 참(true)</b>이라면 주어진 코드를 반복하는 기계라고 할 수
        있습니다. (반복문이라고 합니다.)
      </p>
      <p>
        기본적으로 컴퓨터는 계산기이기 때문에, 어떤것을 반복하겠다는 것도, 반복이 끝날 시점도 모두
        조건으로 정해줘야 합니다.
      </p>
      ...
      <p>
        여기에서는 img 엘리먼트를 만들어 그림 주소, 그림 넓이, 그림 높이, 그림 대체 문자를
        삽입했습니다.
      </p>
      <p>그리고 appendChild가 아닌 insertBefore를 사용했습니다.</p>
      <p>
        저 기능은 이름 그대로 어떤 요소를 다른 요소의 before로 추가하겠다는 의미인데요. (before -
        current - after)
      </p>
      <p>여기에서는 image를 body의 첫번째 자식요소 앞에다가 추가하겠다는 의미로 사용되었습니다.</p>
      <br />
      <p>여기까지 오셨다면 짜잔~ 자바스크립트를 이용한 간단한 실습이 완성되었습니다.</p>
      <CustomImageWithCaption
        imageSrc={SelfIntroduceDocument}
        width={360}
        height={571}
      ...
      <p>여기서 멈추기는 아깝습니다. 약간의 어거지를 더해서 몇가지 기능을 추가해보도록 합시다.</p>
      ...
      <p>CSS라는 stylesheet를 이용해 더 효율적인 스타일링과 애니메이션 기능을 추가할 수 있지만</p>
      <p>DOM을 통해서도 가능하다는 것을 보여드리고 싶었습니다.</p>
      <p>자바스크립트로도 다 할 수 있다는 것을요!!</p>
      <br />
      <h3>오리엔테이션 폭파 with 이벤트 리스너</h3>
      <p>
        이제 모든 것을 없애는 버튼을 만들겠습니다. 버튼을 클릭하면 우리가 만든 모든 것이 사라집니다.
      </p>
      ...
      <ol>
        ...
        <li>
          여러 데이터를 함께 보관하기 위해 배열을 사용했고, 반복문을 이용해 배열 속 데이터를 화면에
          표시했다.
        </li>
        <li>HTML의 메타태그인 style을 이용해 특정 애니메이션을 주입했다.</li>
        <li>
          함수를 선언했고, 사용자와 상호작용(클릭 등)을 하는 이벤트 리스너를 사용했으며, 이벤트가
          일어날 때 실행될 콜백함수를 만들었다.
        </li>
      </ol>
      <p>생각보다 많은 것을 다루셨습니다!</p>
      <p>사실 이렇게 실전으로 배워서 프로그래밍의 고수가 되시는 분들도 많은 것 같습니다.</p>
      <p>뭐... 사실 어떤 방식이든, 맞는 방법을 찾으시면 되는 것 같아요.</p>
      <p>저는 언어의 원리를 좀 더 이해하는 방식의 공부를 좋아해서 이 방향을 택했습니다. ㅎㅎ</p>
      <br />
      <p>다음 챕터부터는 자바스크립트 문법에 대해 본격적으로 공부해볼 것입니다.</p>
      <p>DOM을 다루는 일은 당분간 없을 예정입니다.</p>
      <p>하지만 커리큘럼이 끝날 때 쯤, 스스로 DOM을 컨트롤 하실 수 있을 겁니다!</p>
      <p>함께 가시죠!</p>
    </div>
  );
}
